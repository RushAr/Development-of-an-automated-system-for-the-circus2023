...
Также под выступлением есть мини-форум, где пользователи могут оставлять комментарии.

Информация о всех действиях идет в аналитику которая доступна директору, где указано какие билеты и по какой цене покупали. Исходя из этого можно анализировать финансовые данные предприятия.

Эти данные в автоматическом режиме будут идти в статистику и изменять таблицу отчетов.
